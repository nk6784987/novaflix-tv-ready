    ...
    fun loadSeriesData(force: Boolean = false) {
        ...
        loadJob = viewModelScope.launch {
            ...
            try {
                ...
                val top10 = repository.getTopTen(MediaType.TV, allItems)
                ...
                _uiState.update {
                    it.copy(
                        isLoading = false,
                        error = e.localizedMessage ?: "Failed to load series content"
                    )
                }
            }
        }
